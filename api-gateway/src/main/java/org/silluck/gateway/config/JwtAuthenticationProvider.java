package org.silluck.gateway.config;
...
import org.silluck.gateway.common.UserType;
import org.silluck.gateway.common.UserVo;
import org.silluck.gateway.util.Aes256Util;
...
public class JwtAuthenticationProvider {
    ...
    public String createToken(String userPk, Long id, UserType userType) {
        ...
        claims.put("roles", userType.getKey());
    ...
    public Claims parsedClaims(String token) {
        try {
